...
/** Key glyph for the "Set Password" entry in the lock button's context menu. */
...
/** Counter-clockwise rotate glyph for the "Reset Password" context-menu entry. */
export function ResetKeyIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function ZoomToExtentIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M15 3h6v6"/>
      <path d="M9 21H3v-6"/>
...
/** Funnel glyph for the attribute-filter toggle and the "Filtered" row chip. */
...
/** Geoprocessing tool icon (overlapping polygons with a gear). */
export function GeoProcessingIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
...
/** PostgreSQL/PostGIS database icon (cylinder with layers). */
export function PostgisDatabaseIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
      fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
      strokeLinejoin="round" aria-hidden="true">
...
/** Search magnifying glass — used in the layer-list search toggle. */
